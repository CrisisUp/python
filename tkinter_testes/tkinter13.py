...
def atualizar_tags():
    ...
    fonte_atualizada = font.Font(family=nova_fonte, size=novo_tamanho)

    campo_texto.configure(font=fonte_atualizada)

    fonte_negrito = font.Font(family=nova_fonte, size=novo_tamanho, weight="bold")
    campo_texto.tag_configure("negrito", font=fonte_negrito)

    fonte_italico = font.Font(family=nova_fonte, size=novo_tamanho, slant="italic")
    campo_texto.tag_configure("italico", font=fonte_italico)
